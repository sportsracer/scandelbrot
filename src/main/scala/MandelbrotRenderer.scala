...
trait ColorfulRendering:
  ...
  /** Return 0 if value is smaller than lower bound, 1 if larger than upper
    * bound, or a linearly scaled value in [0, 1] if in between.
    */
...
object ColorfulMandelbrotRenderer
    extends MandelbrotRenderer
    with ColorfulRendering
